...
//  short int *             field4_ptr;  // size=8, offset=200
//  short int *             field5_ptr;  // size=8, offset=208
//  short int *             field6_ptr;  // size=8, offset=216
//  short int *             field7_ptr;  // size=8, offset=224
//  short unsigned int *    field8_ptr;  // size=8, offset=232
//  short unsigned int *    field9_ptr;  // size=8, offset=240
...
//  long int *              field15_ptr; // size=8, offset=288
//  long int *              field16_ptr; // size=8, offset=296
//  long int *              field17_ptr; // size=8, offset=304
//  long int *              field18_ptr; // size=8, offset=312
//  long unsigned int *     field19_ptr; // size=8, offset=320
//  long unsigned int *     field20_ptr; // size=8, offset=328
//  long long int *         field21_ptr; // size=8, offset=336
//  long long int *         field22_ptr; // size=8, offset=344
//  long long int *         field23_ptr; // size=8, offset=352
//  long long int *         field24_ptr; // size=8, offset=360
//  long long unsigned int *field25_ptr; // size=8, offset=368
//  long long unsigned int *field26_ptr; // size=8, offset=376
